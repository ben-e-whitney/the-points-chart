$(document).ready(function() {
  ...
  var chores_edit_URL = '/chores/actions/edit/';
  var steward_edit_URL = '/steward/actions/edit/';
  var create_ids_and_URLs = [
  ...
  $.each(create_ids_and_URLs, function(key, args) {
  ...
  $.each(edit_ids_and_URLs, function(key, args) {
